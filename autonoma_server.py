...
# Base directory: where mcp_server.py lives
...
async def cq_import_export(
    ...
    AVAILABLE PARTS CATALOG (paths relative to this script's directory):

    Boards:
      Arduino:
        - Arduino Nano: Parts/Boards/arduino_nano_r3.step
        - Arduino UNO: Parts/Boards/arduino_uno.step
        - Arduino Mega: Parts/Boards/arduino_mega.step
        - Arduino Nano Extension Board: Parts/Boards/arduino_nano_expansion_shield.step
        - Arduino Display 2.4 TFT SPI 240x320: Parts/Displays/arduino_2-4_tft_spi_240x320.step

      Raspberry Pi:
        - Raspberry PI Pico: Parts/Boards/raspberry_pi_pico_r3.step
        - Raspberry PI 4B: Parts/Boards/raspberry_pi_4B.step # IMPORTANT: This file is extremely large, so try to avoid using it. Use Raspberry PI Pico or Arduino boards instead.
        - Raspberry PI Camera (170 degree): Parts/Cameras/raspberry_pi_camera_170_angle.step
        - Raspberry PI Display 3.5 TFT SPI 480x320: Parts/Displays/raspberry_pi_3.5_tft_display_spi_480x320.step

      LCDs:
        - LCD 4x20 backlight: Parts/Displays/generic_lcd_4x20_backlight.step
        - Smart LCD Ramps: Parts/Displays/smart_lcd_ramps.step

    Batteries and Cells:
      18650 Lithium-Ion:
        - Single cell (3.7-4V): Parts/Batteries/18650_single_cell.step
        - Single cell with holder (3.7-4V): Parts/Batteries/18650_single_cell_holder_with_cell.step
        - 3x cell holder without cells (11-12V): Parts/Batteries/18650_holder_3_cells_12v.step
        - 3x cell holder with cells (11-12V): Parts/Batteries/18650_holder_3_cells_12v_with_cells.step
        - 4x cell holder without cells (14-16V): Parts/Batteries/18650_holder_4_cells_16v.step
        - 4x cell holder with cells (14-16V): Parts/Batteries/18650_holder_4_cells_16v_with_cells.step

      AAA Cells:
        - Single cell (1.5V): Parts/Batteries/battery-AAA.step
        - 4x cell holder without cells (6V): Parts/Batteries/battery-holder-4-AAA.step

      9V Battery:
        - 9V battery: Parts/Batteries/battery_9v.step

      LiPo:
        - 3.7V 1200mAh: Parts/Batteries/lipo_3_7v_1200mAh.step

    Motors:
      DC Motors:
        - L-shaped yellow gear motor: Parts/Motors/Yellow_gearmotor_L.step
        - Straight yellow gear motor: Parts/Motors/Yellow_gearmotor_straight.step
        - Pololu 298 1.6V: Parts/Motors/Pololu_298_1_6V.step
        - Metal gear motor 37mm: Parts/Motors/Metal_gearmotor_37mm.step

      Stepper:
        - NEMA 17: Parts/Motors/NEMA_17_with_connector.step
        - NEMA 23: Parts/Motors/NEMA_23_with_connector.step

      Servo:
        - EMAX ES08A: Parts/Motors/Servo_emax_es08A.step

    Wheels:
      - 65mm yellow wheel (for yellow gear motors): Parts/Motors/Yellow_wheel_65mm.step

    Sensors:
      IR Sensor:
        - IR sensor: Parts/Sensors/IR_sensor.step

      Ultrasonic Sensor:
        - HC-SR04: Parts/Sensors/Ultrasonic_sensor_HC_SR04.step

    Other:
      Robotic Arm Grippers:
        - Gripper with 2 claws: Parts/Other/robotic_arm_gripper_1.step
        - Gripper with 4 claws: Parts/Other/robotic_arm_gripper_2.stp
    ...
    Args:
        ...
        file_path: Path to STEP file
            ...
            - Export: Filename or full path. If just a filename (e.g., "box.step"),
              automatically saves to the exports/ directory next to this script.
    ...
    Examples:
        ...
        {
            "operation": "import",
            "file_path": "Parts/Boards/arduino_nano_r3.step",
        ...
        {
            "operation": "import",
            "file_path": "Parts/Motors/NEMA_17_with_connector.step"
        }
        ...
        Export to specific path:
        {
            ...
            "file_path": "/path/to/custom/assembly.step"
        }
    ...
    try:
        ...
        if operation == "import":
            ...
            # 1. Resolve relative paths against the script's directory
            ...
            # 4. Generate storage name if not provided
            if store_as is None:
